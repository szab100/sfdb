...
// It is provided only for efficiency, given that message-less CANCELLED errors
// are common in the infrastructure.
// inline Status CancelledError() { return Status(StatusCode::kCancelled); }
